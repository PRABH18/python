...
class HotelManagementSystem:
    def __init__(self,root):
        ...
        self.root.geometry("15500x880+0+0")

#========================First img======================================

        img1=Image.open(r"E:\VS CODE\image\WhatsApp Image 2021-07-26 at 5.26.30 AM.jpeg")
        ...
        img2 = Image.open(r"E:\VS CODE\image\python.jfif")
...
# =============================title=================================================
        lbl_title=Label(self.root,text="Singh Hotel Management System",font=("times new roman",27,"bold"),bg="black",fg="gold",bd=4,relief=RIDGE)
...
# ========================================btn frame===========================================================
        ...
        img3 = Image.open(r"E:\VS CODE\image\download (1).jfif")
        ...
        img4 = Image.open(r"E:\VS CODE\image\download (1).jfif")
        ...
        img5 = Image.open(r"E:\VS CODE\image\download (1).jfif")
